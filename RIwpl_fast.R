...
for(i in 1:LOTS){
   ...
   rb<-fit_PL(StrSRSWORSample$y,StrSRSWORSample$cluster, StrSRSWORSample$x,pars=c(truevalue[1:2], log(truevalue[3:4])) )
   ...
   rbis<-fit_PL(y=StrSRSWORSampleis$y,g=StrSRSWORSampleis$cluster, x=StrSRSWORSampleis$x,pars=c(truevalue[1:2], log(truevalue[3:4])))
   rcis<-fit_WPL( y=StrSRSWORSampleis$y,g=StrSRSWORSampleis$cluster,
                       x=StrSRSWORSampleis$x, StrSRSWORSampleis$ID_unit,StrSRSWORSampleis$strata, n2infor=n2is, N2, pars=c(truevalue[1:2], log(truevalue[3:4])))
   ...
   H_PL[,,i]=-jacobian(function(theta){with(StrSRSWORSample,
